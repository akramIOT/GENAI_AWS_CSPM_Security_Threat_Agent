...
##  Add  St.Cache and other  Streamlit handlers to customize the UI code as per  your Business logic  requirements.
with st.sidebar:
...
if submit_button:
    ...
    ## DB could be changed with any other GraphDB as well in Future.
